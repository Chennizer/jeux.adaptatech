import { createLagoonScene } from './lagoon-scene.js';
import { createLanternScene } from './lantern-scene.js';
import { createMountainDawnScene } from './mountain-dawn-scene.js';
import { createBambooGardenScene } from './bamboo-garden-scene.js';
import { createCelestialBreathScene } from './celestial-breath-scene.js';
...
const SCENE_SOUNDTRACKS = {
  lagoon: '../../sounds/sadness/softrain.mp3',
  lanterns: '../../sounds/sadness/candle.mp3',
  'mountain-dawn': '../../sounds/sadness/windandsnow.mp3',
  bamboo: '../../sounds/sadness/subtlewind.mp3',
  'celestial-breath': '../../sounds/sadness/subtlewind.mp3'
};
...
const sketch = p => {
  p.setup = () => {
    ...
    scenes = [
      ...
      createMountainDawnScene(p),
      createBambooGardenScene(p),
      createCelestialBreathScene(p)
    ];
