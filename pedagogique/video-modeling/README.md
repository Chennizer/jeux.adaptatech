...
Une bande fixe de vignettes au bas de l’écran présente les vidéos dans l’ordre, avec leur titre en dessous. La vignette actuelle est soulignée et son titre est en gras. Le repère reste visible pendant le choix et la lecture, sans animation, et ne permet pas de sauter une étape. Si la séquence dépasse la place disponible, les vignettes proches de l’étape actuelle restent affichées et des points de suspension indiquent les autres étapes. Aucun défilement n’est nécessaire. La vidéo conserve ses proportions au-dessus du bandeau.
