...
export function createLanternScene(p) {
  ...
  function drawNightSky() {
    ...
    for (let y = 0; y < p.height; y += 4) {
      ...
      const c1 = p.color(255, 220, 180);
      const c2 = p.color(255, 192, 222);
  ...
  return {
    id: 'lantern',
    name: 'Lanterne flottante',
    description: 'Ciel rose, flamme joyeuse et étincelles dorées',
    enter() {
      glow = 0;
      entryGlow = 1;
      t = 0;
