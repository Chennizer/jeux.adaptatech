document.addEventListener('DOMContentLoaded', () => {
    ...
    // Tracks whether it's 2-player mode
    ...
    // Preload once everything is ready
    ...
    // Adjusted to read from localStorage to pick the correct language labels
    function loadConfig() {
        ...
        spacePromptImages.forEach((p) => {
            ...
            // alt is an object => pick p.alt[userLang] if you like
        ...
        // Build sound options with correct language
        ...
        // Build visual effect options with correct language
        ...
        // Build the misc items (checkboxes, etc.), also using the correct language
        miscOptions.forEach(o => {
            ...
            if (o.id === 'timed-prompt-option') {
                ...
                const numericLabelText = {
                    fr: "Temps pour appuyer sur la switch (s)",
                    en: "Time to press the switch (s)"
                  };
                  const userLang = localStorage.getItem('siteLanguage') || 'fr';
                ...
                numberInput.min = '1';
                // If o.label is an object, pick the userLang, or just fallback
    ...
    // Hide the placeholder option on focus, etc.
    ...
    // Finally, call loadConfig() to build everything using the correct language
    loadConfig();
});
