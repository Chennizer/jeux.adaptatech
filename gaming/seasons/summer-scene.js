...
export function createSummerScene(p) {
  const palette = {
    skyTop: [216, 232, 247],
    skyBottom: [192, 210, 226],
    meadowLight: [247, 234, 203],
    meadowDeep: [224, 203, 164],
    grassLight: [228, 187, 116],
    grassDeep: [186, 146, 86],
    shadow: [76, 124, 132],
    veil: [255, 235, 190]
  };
    ...
    for (let r = 0; r < rows; r += 1) {
      ...
      for (let c = 0; c < cols; c += 1) {
        ...
        grass.push(new GrassBlade(p, x, baseY + p.random(-6, 6), height, depth, {
          base: lerpColor(p, palette.grassLight, palette.grassDeep, depth)
        }));
      }
    }
  }
